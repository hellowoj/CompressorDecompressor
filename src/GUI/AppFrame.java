...
public class AppFrame extends JFrame implements ActionListener {
    ...
    AppFrame(String name) {
        ...
        buttonPanel.setPreferredSize(new Dimension(getWidth(), 120));
            ...
            decompressButton.setBounds(90,100,200,30);

        compressButton.setBackground(new Color(23, 21, 21)); // Set button background color
        decompressButton.setBackground(new Color(20, 20, 21)); // Set button background color
